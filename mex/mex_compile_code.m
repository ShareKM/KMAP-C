...
elseif ismac
    omp_flag = {'-I/opt/homebrew/opt/libomp/include', ...  % if omp.h does not exist, download with "brew install libomp", the omp installation path can be obtained with "brew --prefix libomp"
